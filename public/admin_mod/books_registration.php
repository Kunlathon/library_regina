					...
					<div class="row">
						<fieldset class="content-group">
							<div class="form-group">
								<label class="control-label col-<?php echo $grid;?>-2" style="font-family: surafont_sanukchang; font-size: 18px;">ค้นหาทะเบียนหนังสือ <span class="text-danger">*</span></label>
